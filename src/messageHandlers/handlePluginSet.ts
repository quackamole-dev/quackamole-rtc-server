...
export const handlePluginSet: MessageHandler = (ws: USocket, message: RequestMessage): void => {
  ...
  const [pluginDb, error] = RoomService.instance.setPlugin(roomId, plugin, wsUserData.user.id, iframeId);
